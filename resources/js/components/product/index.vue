                ...
                <table class="table table-bordered table-striped text-sm table-vcenter table-condensed">
                    ...
                    <tbody>
                        <tr v-for="(product,index) in productList.data" :key="product.id">
                            ...
                            <td nowrap>
                          <router-link :to="{name: 'edit-product', params:{id: product.id} }" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></router-link>
                        <a @click="deleteProduct(product.id)" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
