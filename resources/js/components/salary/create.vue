...
<div>
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Paid Salary</h3>
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form @submit.prevent="salaryPaid" autocomplete="off" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Salary</label>
                                <input type="text" class="form-control" v-model="form.salary" placeholder="" autofocus>
