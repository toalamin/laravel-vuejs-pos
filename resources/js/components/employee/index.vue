                ...
                <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 300px;">
                        ...
                        <div class="input-group-append">
                            ...
                            <router-link :to="{name: 'employee-create'}" class="btn btn-sm btn-info"><i class="fa fa-plus"></i> Add</router-link>
                ...
                <table class="table table-bordered table-striped text-sm table-vcenter table-condensed">
                    ...
                    <tbody>
                        <tr v-for="(employee,index) in employeeList.data" :key="employee.id">
                            ...
                            <td nowrap>
                          <router-link :to="{name: 'edit-employee', params:{id: employee.id} }" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></router-link>
                        <a @click="deleteEmployee(employee.id)" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
