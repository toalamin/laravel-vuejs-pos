                  ...
                  <div class="card-header">
                       ...
                       <table class="table table-sm table-striped">
                        ...
                        <tbody>
                          <tr v-for="card in cards" :key="card.id">
                            <th>{{ card.pro_name }}</th>
                            <td nowrap><input type="text" readonly="" style="width: 20px;" :value="card.pro_quantity">
                    ...
                    <form @submit.prevent="orderdone">
                      ...
                      <select class="form-control" v-model="customer_id">
                         <option :key="customer.id" :value="customer.id" v-for="customer in customers">{{ customer.name }}</option>
                      </select>
          ...
          <div class="card col-lg-7">
            ...
            <div class="card-body">
               ...
               <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                 ...
                 <li class="nav-item" v-for="category in categories.data" :key="category.id">
                 ...
                 <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <input type="text" v-model="searchTerm" class="form-control" placeholder="search"><br>
                    <div class="row">
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6 col-6" v-for="(product , index) in filtersearch" :key="product.id">
                       <button class="btn bt-sm" @click.prevent="AddToCart(product.id)">
                        <div class="card" style="width: 9rem; height: 180px;">
                          <img :src="product.photo" class="card-img-top" onerror="this.src='/backend/images/noimage.png'"  style="height: 100px; width: 100px;">
                          <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-lg-3 col-md-4 col-sm-6 col-6" v-for="getproduct in getfiltersearch" :key="getproduct.id">
                       <button class="btn btn-sm" @click.prevent="AddToCart(getproduct.id)">
                        <div class="card" style="width: 9rem; height: 180px;">
                          <img :src="getproduct.photo"  onerror="this.src='/backend/images/noimage.png'"  class="card-img-top" style="height: 100px; width: 100px;">
                          <div class="card-body">
