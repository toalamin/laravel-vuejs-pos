...
<div>
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form @submit.prevent="addExpense" autocomplete="off" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Note</label>
                                <textarea  class="form-control" v-model="form.details" placeholder="" autofocus></textarea>
